...
public:
	...
	void drawLight() {
		float vertices[] = {
		-0.5f + position.x, -0.5f + position.y, -0.5f + position.z,  0.0f,  0.0f, -1.0f,
		 0.5f + position.x, -0.5f + position.y, -0.5f + position.z,  0.0f,  0.0f, -1.0f,
		 0.5f + position.x,  0.5f + position.y, -0.5f + position.z,  0.0f,  0.0f, -1.0f,
		 0.5f + position.x,  0.5f + position.y, -0.5f + position.z,  0.0f,  0.0f, -1.0f,
		-0.5f + position.x,  0.5f + position.y, -0.5f + position.z,  0.0f,  0.0f, -1.0f,
		...
		-0.5f + position.x,  0.5f + position.y,  0.5f + position.z, -1.0f,  0.0f,  0.0f,
		-0.5f + position.x,  0.5f + position.y, -0.5f + position.z, -1.0f,  0.0f,  0.0f,
		-0.5f + position.x, -0.5f + position.y, -0.5f + position.z, -1.0f,  0.0f,  0.0f,
		-0.5f + position.x, -0.5f + position.y, -0.5f + position.z, -1.0f,  0.0f,  0.0f,
		-0.5f + position.x, -0.5f + position.y,  0.5f + position.z, -1.0f,  0.0f,  0.0f,
		...
		-0.5f + position.x, -0.5f + position.y, -0.5f + position.z,  0.0f, -1.0f,  0.0f,
		 0.5f + position.x, -0.5f + position.y, -0.5f + position.z,  0.0f, -1.0f,  0.0f,
		 0.5f + position.x, -0.5f + position.y,  0.5f + position.z,  0.0f, -1.0f,  0.0f,
		 0.5f + position.x, -0.5f + position.y,  0.5f + position.z,  0.0f, -1.0f,  0.0f,
		-0.5f + position.x, -0.5f + position.y,  0.5f + position.z,  0.0f, -1.0f,  0.0f,
