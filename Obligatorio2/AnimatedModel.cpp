...
void AnimatedModel::initShaders(GLuint shader_program)
{
...
void AnimatedModel::draw(GLuint shaders_program)
{
	vector<aiMatrix4x4> transforms;
	boneTransform((double)SDL_GetTicks() / 1000.0f, transforms);

	for (uint i = 0; i < transforms.size(); i++) // move all matrices for actual AnimatedModel position to shader
	{
...
void AnimatedModel::loadModel(const string& path)
{
...
void AnimatedModel::showNodeName(aiNode* node)
{
...
vector<Mesh> AnimatedModel::getMeshes()
{
	return meshes;
}

glm::vec3 AnimatedModel::getMin()
{
	return min;
}
glm::vec3 AnimatedModel::getMax()
{
	return max;
}
...
vector<Texture> AnimatedModel::LoadMaterialTexture(aiMaterial* mat, aiTextureType type, string type_name)
{
	vector<Texture> textures;
	for (uint i = 0; i < mat->GetTextureCount(type); i++)
	{
		...
		Texture texture;
		texture.id = Settings::TextureFromFile(filename.c_str()); // return prepaired openGL texture
...
uint AnimatedModel::findPosition(float p_animation_time, const aiNodeAnim* p_node_anim)
{
	// ����� ���� ������� ����� ����� ����� ������� ���������� ����� ������ ��������
...
uint AnimatedModel::findRotation(float p_animation_time, const aiNodeAnim* p_node_anim)
{
	// ����� ���� ������� ����� ����� ����� ������� ���������� ����� ������ ��������
...
uint AnimatedModel::findScaling(float p_animation_time, const aiNodeAnim* p_node_anim)
{
	// ����� ���� ������� ����� ����� ����� ������� ���������� ����� ������ ��������
...
aiVector3D AnimatedModel::calcInterpolatedPosition(float p_animation_time, const aiNodeAnim* p_node_anim)
{
...
aiQuaternion AnimatedModel::calcInterpolatedRotation(float p_animation_time, const aiNodeAnim* p_node_anim)
{
...
aiVector3D AnimatedModel::calcInterpolatedScaling(float p_animation_time, const aiNodeAnim* p_node_anim)
{
...
const aiNodeAnim* AnimatedModel::findNodeAnim(const aiAnimation* p_animation, const string p_node_name)
{
...
// start from RootNode
void AnimatedModel::readNodeHierarchy(float p_animation_time, const aiNode* p_node, const aiMatrix4x4 parent_transform)
{
...
void AnimatedModel::boneTransform(double time_in_sec, vector<aiMatrix4x4>& transforms)
{
